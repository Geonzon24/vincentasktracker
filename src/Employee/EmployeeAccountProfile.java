...
public class EmployeeAccountProfile extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("EMPLOYEE ACCOUNT PROFILE");
        ...
        jHomeButton.setBounds(17, 150, 130, 24);
        ...
        jHomeButton2.setBounds(17, 173, 130, 24);
    ...
    private void jHomeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jHomeButtonActionPerformed
        EmployeeDashboard EB = new EmployeeDashboard();
        EB.setVisible(true);
        EB.pack();
    ...
    private void jHomeButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jHomeButton1ActionPerformed
        EmployeeChangePassword ep = new EmployeeChangePassword();
        ep.setVisible(true);
        ep.pack();
    ...
    private void jHomeButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jHomeButton3ActionPerformed
        EmployeeUpdateProfile up = new EmployeeUpdateProfile();
        up.setVisible(true);
        up.pack();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmployeeAccountProfile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
